...
function SetASparseVecMat(
    ...
    alpha::Cdouble,
    ishift::Integer,
    ind::Union{Ptr{Cint},Vector{Cint}},
    val::Union{Ptr{Cdouble},Vector{Cdouble}},
    nnz::Integer,
)
    @dsdp_ccall SDPConeSetASparseVecMat (
        SDPConeT,
        Cint,
        Cint,
        Cint,
...
function SetADenseVecMat(
    ...
    @dsdp_ccall SDPConeSetADenseVecMat (
        SDPConeT,
        Cint,
        Cint,
        Cint,
...
function AddASparseVecMat(
    ...
    arg5::Cdouble,
    arg6::Integer,
    arg7::Union{Ptr{Cint},Vector{Cint}},
    arg8::Union{Ptr{Cdouble},Vector{Cdouble}},
    arg9::Integer,
)
    @dsdp_ccall SDPConeAddASparseVecMat (
        SDPConeT,
        Cint,
        Cint,
        Cint,
        ...
        Ptr{Cdouble},
        Cint,
    ) sdpcone arg2 arg3 arg4 arg5 arg6 arg7 arg8 arg9
end

function AddADenseVecMat(
    sdpcone::SDPConeT,
    arg2::Integer,
    arg3::Integer,
    arg4::Integer,
    ...
    @dsdp_ccall SDPConeAddADenseVecMat (
        SDPConeT,
        Cint,
        Cint,
        Cint,
...
function AddSparseVecMat(
    ...
    @dsdp_ccall SDPConeAddSparseVecMat (
        SDPConeT,
        Cint,
        Cint,
        Cint,
        ...
        Ptr{Cdouble},
        Cint,
    ) sdpcone arg2 arg3 arg4 arg5 arg6 arg7 arg8
end

function AddDenseVecMat(
    sdpcone::SDPConeT,
    arg2::Integer,
    arg3::Integer,
    arg4::Integer,
    ...
    @dsdp_ccall SDPConeAddDenseVecMat (
        SDPConeT,
        Cint,
        Cint,
        Cint,
        Ptr{Cdouble},
        Cint,
    ) sdpcone arg2 arg3 arg4 arg5 arg6
end

function SetSparseVecMat(
    sdpcone::SDPConeT,
    arg2::Integer,
    arg3::Integer,
    arg4::Integer,
    ...
    @dsdp_ccall SDPConeSetSparseVecMat (
        SDPConeT,
        Cint,
        Cint,
        Cint,
...
function SetDenseVecMat(
    ...
    @dsdp_ccall SDPConeSetDenseVecMat (
        SDPConeT,
        Cint,
        Cint,
        Cint,
...
function GetXArray(sdpcone::SDPConeT, blockj::Integer)
    ...
    return unsafe_wrap(Array, xmat[], nn[])
end

function RestoreXArray(
    sdpcone::SDPConeT,
    arg2::Integer,
    arg3,
    arg4::Vector{Cint},
)
    @dsdp_ccall SDPConeRestoreXArray (
        SDPConeT,
        Cint,
        Ptr{Ptr{Cdouble}},
        Ptr{Cint},
    ) sdpcone arg2 arg3 arg4
end
...
function XVMultiply(
    ...
    @dsdp_ccall SDPConeXVMultiply (
        SDPConeT,
        Cint,
        Ptr{Cdouble},
        Ptr{Cdouble},
        Cint,
    ) sdpcone arg2 pointer(arg3) pointer(arg4) n
end
...
function AddXVAV(
    ...
    @dsdp_ccall SDPConeAddXVAV (
        ...
        Ptr{Cdouble},
        Cint,
    ) sdpcone arg2 pointer(arg3) length(arg3) pointer(arg5) length(arg5)
end
